...
//        }
//
//        List<Position> result = QueenPiece.getPossibleMoves(0, 4, board);
//        PositionTest.assertPosition(expected, result);
//    }
